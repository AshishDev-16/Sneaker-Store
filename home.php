...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-white">
      ...
      <div class="collapse navbar-collapse nav-buttons" id="navbarSupportedContent">
        <ul class="navbar-nav">
          ...
          <div class="container my-1">
            <h4>Welcome<br><?php echo $_SESSION['username']; ?></h4>
          </div>
    ...
    <video class="HOME" autoplay muted loop>
    <source src="assets\vdos\AD.webm" type="video/webm">
    </video>
    ...
    while($row = mysqli_fetch_assoc($result))
    {
      ...
      <img class='img-fluid pb-2' src='assets/imgs/$name/$img'>
  ...
  <section id="all" class="my-5 pd-2">
    <div class="container text-center mt-5 py-2">

...
<body>
  ...
  <section class="my-5 py-5">
          ...
          if($_SERVER['REQUEST_METHOD']=='POST')
          {
            ...
            $stmt="INSERT INTO `users` ( `user_name`, `user_email`, `user_password`) VALUES ( '$name', '$email', '$password')";
        ...
        <form id="register-form" method="POST">
            ...
            <div class="form-group">
                <a class="btn" id="login-url" href="index.php">Already have an account? Login</a>
            </div>
        </form>
    </div>
  </section>

...
if($_SERVER['REQUEST_METHOD']=='POST')
{
  ...
  $stmt="select * from `users` where user_email='$email' AND user_password='$password'";
...
?>
    ...
    <form id="login-form" method="POST">
            ...
            <div class="form-group">
                <a class="btn" id="register-url" href="register.php">Don't have account? Register</a>
            </div>
            <div class="form-group">
                <a class="btn" id="register-url" href="adminlog.php">Admin login</a>
            </div>
        </form>
    </div>
  </section>
